...
/*
    ...
    public static <T> void writeObjListToExcelToReceive(List<T> objList, String fileName, Context c) {
        if (objList != null && objList.size() > 0) {
            ...
            try {
                ...
                for (int j = 0; j < objList.size(); j++) {
                    ReceiveDataBean projectBean = (ReceiveDataBean) objList.get(j);
                    List<String> list = new ArrayList<>();
                    list.add(""+(projectBean.getReceiveData()));
    ...
    @SuppressWarnings("unchecked")
    public static <T> void writeObjListToExcelToInitFive(List<T> objList, String fileName, Context c) {
        if (objList != null && objList.size() > 0) {
            WritableWorkbook writebook = null;
            InputStream in = null;
            try {
